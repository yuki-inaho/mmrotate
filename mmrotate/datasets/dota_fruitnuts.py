...
class DOTAFruitNutsDataset(BaseDataset):
    """
    ...
    METAINFO = {"classes": ("date", "fig", "hazelnut"), "palette": [(165, 42, 42), (189, 183, 107), (0, 255, 0)]}

    def __init__(self, img_shape: Tuple[int, int] = (1024, 1024), diff_thr: int = 100, **kwargs) -> None:
    ...
    def load_data_list(self) -> List[dict]:
        ...
        data_list = []
        if self.ann_file == "":
            img_files = glob.glob(osp.join(self.data_prefix["img_path"], "*.jpg"))
